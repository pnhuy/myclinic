...
class Metadata(models.Model):
    ...
    metadata_concept = models.ForeignKey(
        Concept, on_delete=DEFAULT_ON_DELETE, related_name="metadata_concept_ids"
    )
    metadata_type_concept = models.ForeignKey(
        Concept, on_delete=DEFAULT_ON_DELETE, related_name="metadata_type_concept_id"
    )
    ...
    value_as_concept = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="value_as_concept_ids",
    )
    ...
    def __str__(self):
        concept_name = self.metadata_concept.concept_name
        return f"[{self.metadata_id}] {concept_name}"
...
class CdmSource(models.Model):
    ...
    cdm_version_concept = models.ForeignKey(Concept, on_delete=DEFAULT_ON_DELETE)
